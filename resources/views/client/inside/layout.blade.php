   ...
   <body onload="pageLoad()">
      ...
      <nav class="navbar navbar-default navbar-fixed-top menu" role="navigation">
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="https://id2.tinhkiem.us/Home">
            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav navbar-right menu-right">
                  <li class="dropdown tk-an">
                     ...
                     <span id="txttentk">demo12345[1639668]</span>
                     </span><i class="arrowdow"></i>
                     </a>
                     <ul class="dropdown-menu menu-click">
                        <a onclick="__doPostBack(&#39;BtnBuyCharacter&#39;, &#39;InfoAccount&#39;)">Thông tin tài khoản</a>
                        <a href="https://id2.tinhkiem.us/Logout">Thoát</a>
                     </ul>
                  </li>
                  <li>
                     <div class="Menuthanh">
      ...
      <div id="wrapper">
         ...
         <section class="bg-white" id="section1">
            <div class="container">
               <div class="row">
                  <form method="post" action="https://id2.tinhkiem.us/Home.aspx" id="ctl00">
