            ...
            <div class="form-bottom">
               <div id="ContentPlaceHolder1_UpdatePanel1">
                  <div class="form-horizontal bv-form" id="contact_form" novalidate="novalidate">
                     ...
                     <div class="form-group margin">
                        <input name="name" type="text" placeholder="Tên đăng nhập (6-12 ký tự)" class="form-control">
                     </div>
                     <div class="form-group margin">
                        <input name="password" type="password"  placeholder="Mật khẩu  (6-12 ký tự)" class="form-control">
                     </div>
                     <div class="form-group margin">
                        <input name="password2" type="password" placeholder="Mật khẩu cấp 2  (6-12 ký tự)" class="form-control">
                     </div>
                     <div class="form-group margin">
                        <input name="email" type="text" id="ContentPlaceHolder1_txtemail" placeholder="Email " class="form-control">
                     </div>
                     <div class="form-group margin">
                     ...
                     <div class="form-group margin">
                        <input name="answer" type="text"  placeholder="Câu trả lời (6-20 ký tự)" class="form-control">
                     </div>
                     <div class="form-group margin">
                        <input name="phone" type="text" placeholder="Số điện thoại" class="form-control">
                     </div>
                     <div class="form-group margin">
                        <input name="referral_code" type="text" placeholder="Mã giới thiệu" class="form-control">
                     </div>
                     <div class="form-group margin">
                     </div>
                     <div class="form-group margin">
