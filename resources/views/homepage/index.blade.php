        ...
        <div class="row nav">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="#"><img src="{{asset('homepage/img/Logo.png')}}"></a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="{{asset('homepage/img/co-kiem.jpg')}}" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{asset('homepage/img/Baro Kieesm.png')}}" alt="Second slide">
            <div class="carousel-caption d-none d-md-block view-1">
              <a href=""><img src="./assets/img/e1.png"></a>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{asset('homepage/img/3333.png')}}" alt="Third slide">
            <div class="carousel-caption d-none d-md-block view-2">
              <a href=""><img src="./assets/img/e2.png"></a>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="{{asset('homepage/img/BG Section 111-min.jpg')}}" alt="Third slide">
      ...
      <div class="may d-none d-md-block">
        <img src="{{asset('homepage/img/22.png')}}">
      </div>
</header>
<main>
    <div class="container">
        <div class="row">
            <div class="main-left col-md-12 col-lg-9 col-xl-9">
                <div class="option row">
                    <div class="col-4 col-md-4 col-css" data-aos="zoom-in" style="position: relative;"><img class="down" src="{{asset('homepage/img/tai-game.png')}}" ></div>
                    <div class="col-4 col-md-4 col-css" data-aos="zoom-in"><img src="{{asset('homepage/img/b.png')}}" ></div>
                    <div class="col-4 col-md-4 col-css" data-aos="zoom-in"><img src="{{asset('homepage/img/c.png')}}" ></div>
                </div>
                <div class="row">
                        ...
                        <div class="content-2 " data-aos="slide-up" >
                            <div class="row">
                                ...
                                <div class="col-css col-md-5 background">
                                    ...
                                    <ul>
                                        <li style="background-image: url('{{asset('homepage/img/14.png')}}');">Namduong</li>
                                        <li style="background-image: url('{{asset('homepage/img/15.png')}}');">Namduong</li>
                                        <li style="background-image: url('{{asset('homepage/img/16.png')}}');">Namduong</li>
                                        <li style="background-image: url('{{asset('homepage/img/17.png')}}');">Namduong</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="main-right col-md-12 col-lg-3 col-xl-3 col-css" data-aos="fade-left">
                 <div class="background">
                    ...
                    <ul>
                        <li><a href="" style="background-image: url('{{asset('homepage/img/fa.png')}}')">Link Facebook</a></li>
                        <li><a href="" style="background-image: url('{{asset('homepage/img/mail.png')}}');">Email</a></li>
                    </ul>
                  </div>
            </div>
        </div>
    ...
    <div class="may-2 d-none d-md-block">
      <img src="{{asset('homepage/img/23.png')}}">
    </div>
</main>
<footer>
    <div class="container">
